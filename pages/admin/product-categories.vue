      ...
      <div class="columns">
        <div class="column is-one-third">
          <form @submit.prevent="onSubmit">
            <div class="field">
              <label class="label" v-if="!category">New
                category</label>
              <label class="label" v-else>Update
                category</label>
              <div class="control">
                <input class="input" type="text"
                  name="name" v-model="name"
                  v-validate="'required'" :class="{ 'is-danger': errors.has('name') }">
          ...
          <table class="table is-striped is-fullwidth">
            ...
            <tbody>
              <tr v-for="(category, index) in categories"
                :key="category.key">
                <th>{{ ++index }}</th>
                <td><a href="#" @click.prevent="selectCategory(category)">{{
                    category.name }}</a></td>
                <td><a href="#" @click.prevent="removeCategory(category)"><span
